---
title: "ColorMap API Reference — mapres Color Formatting"
sidebarTitle: "ColorMap"
description: "API reference for ColorMap and its three built-in instances: ascii_colors (ANSI), mc_colors (Minecraft), and strip_colors. Uses angle-bracket syntax."
---
