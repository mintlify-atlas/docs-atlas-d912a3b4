---
title: "Exception Classes API Reference — mapres Error Handling"
sidebarTitle: "Exceptions"
description: "Reference for the three mapres exception classes: MapResError (base), MissingKeyError (undefined placeholder), and MapSyntaxError (invalid pattern)."
---
