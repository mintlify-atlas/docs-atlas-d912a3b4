---
title: "DataMap and @datamap Decorator API Reference"
sidebarTitle: "DataMap"
description: "API reference for the DataMap base class, the @datamap decorator, the syntax class, and all decorator shortcut forms for defining typed template contexts."
---
