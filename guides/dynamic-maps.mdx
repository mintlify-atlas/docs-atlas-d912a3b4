...
description: "Dynamic mode DataMaps evaluate callable field values or provider functions at resolution time, enabling runtime context like live timestamps, counters, or external data."
---
