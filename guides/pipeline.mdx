---
title: "Transform Strings with the Resolution Pipeline"
sidebarTitle: "Pipeline"
description: "The mapres pipeline lets you chain custom text transformation functions that run before map substitution, enabling preprocessing, sanitization, and custom logic."
---
