...
sidebarTitle: "Layers"
description: "mapres resolves placeholders through a LayerStack — an ordered collection of Layers that determines lookup priority when multiple maps share a key."
---
